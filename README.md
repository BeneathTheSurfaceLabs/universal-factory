# Laravel-style Factory classes for non-Eloquent classes
...
```bash
php artisan vendor:publish --tag="universal-factory-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="universal-factory-views"
```

## Usage

```php
$universalFactory = new BeneathTheSurfaceLabs\UniversalFactory();
echo $universalFactory->echoPhrase('Hello, BeneathTheSurfaceLabs!');
```
